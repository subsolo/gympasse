<%-- 
    Document   : listaAcademia
    Created on : 10/09/2018, 01:05:28
    Author     : Bruno
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="images/academia2.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick exaemple text to build on the card title and make up the bulk of the card's content.</p>
